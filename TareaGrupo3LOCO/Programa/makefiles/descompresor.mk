...
all: descompresorLOCO
.PHONY: all clean_bin

#directorios
HDIR = ../include
CPPDIR = ../src
ODIR = ../obj/descompresor

#compilador
CC = gcc
CFLAGS = -Wall -Werror -I$(HDIR) -g -O3

MODULOS = compartido descompresor pixelio
...
MAIN=descompresorLOCO
EJECUTABLE=descompresorLOCO
...
$(EJECUTABLE): $(ODIR)/$(MAIN).o $(OS)
	$(CC) $(CCFLAGS) $^ -o $@
	$(info ***Compilacion de descompresor exitosa***)
